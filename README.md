...
## Build and deploy the application on WebSphere Application Server 9
...
### 4. Configuring the WebSphere v9 Environment with Security and Resources
...
3. Select _com.ibm.websphere.persistence.PersistenceProviderImpl_ as the Default Persistence Provider.
...
1. Edit the [addBusinessCustomer.sql](https://github.com/ibm-cloud-architecture/refarch-jee-customerorder/blob/was90-prod/Common/addBusinessCustomer.sql) and/or [addResidentialCustomer.sql](https://github.com/ibm-cloud-architecture/refarch-jee-customerorder/blob/was90-prod/Common/addResidentialCustomer.sql) sql files you can find in the Common folder for this repo to define your users in there.
