...
public class CustomerOrderRESTTest extends TestCase {
	...
	private static String urlPrefix = "https://localhost:9444/CustomerOrderServicesWeb/";
	private static String urlTestPrefix = "http://localhost:9081/CustomerOrderServicesTest/";
